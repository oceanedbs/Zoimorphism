...
min_motor_steps_x, max_motor_steps_x = 0, 6500  # Plage de pas en X (ajuster selon le moteur)
min_motor_steps_z, max_motor_steps_z = 0, 1300   # Plage de pas en Z (ajuster selon le moteur)
